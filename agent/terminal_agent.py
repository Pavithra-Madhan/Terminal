...
if __name__ == "__main__":
    test_query = "I need to confirm the database connectivity. Run a simple query against the file_metadata table to retrieve the path and last modified time for all records."
